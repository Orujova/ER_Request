...
const RequestForm = () => {
  ...
  // Create a ref to store file objects - make sure this is defined at the component level
  const fileCache = useRef(new Map());

  console.log(
    "RequestForm rendered, fileCache initialized",
    fileCache.current ? "available" : "not available"
  );
